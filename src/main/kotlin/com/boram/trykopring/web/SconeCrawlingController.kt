...
class SconeCrawlingController {
    ...
    fun list(): String {
        ...
        val keyword = "비건 스콘"
        val searchSite =
            "https://search.shopping.naver.com/search/all?frm=NVSCPRO&origQuery=$keyword&pagingIndex=1&pagingSize=40&productSet=total&query=$keyword&sort=review&timestamp=&viewType=list"
